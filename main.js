...
function handleFileSelect(file) {
  ...
  // Store file reference on the zone element
  document.getElementById('upload-zone')._file = file;
  // Toggle state via CSS class — CSS handles show/hide of empty vs chosen
...
function clearFile() {
  ...
  document.getElementById('upload-zone')._file = null;
